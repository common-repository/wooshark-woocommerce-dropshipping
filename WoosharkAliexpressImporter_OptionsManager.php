    ...
    public function settingsPage() {
        ...
        <form method="post" action="">
            <?php settings_fields($settingsGroup); ?>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/fuaD65JrrBQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><p>
To use the plugin, you need to install the chrome extensionm 
<a href="https://goo.gl/wFAhea" target="_blank">Download from here</a>.
</p>
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'wooshark-aliexpress-importer');
            case 'false':
                return __('false', 'wooshark-aliexpress-importer');

            case 'Administrator':
                return __('Administrator', 'wooshark-aliexpress-importer');
            case 'Editor':
                return __('Editor', 'wooshark-aliexpress-importer');
            case 'Author':
                return __('Author', 'wooshark-aliexpress-importer');
            case 'Contributor':
                return __('Contributor', 'wooshark-aliexpress-importer');
            case 'Subscriber':
                return __('Subscriber', 'wooshark-aliexpress-importer');
            case 'Anyone':
                return __('Anyone', 'wooshark-aliexpress-importer');
        }
        return $optionValue;
    }
