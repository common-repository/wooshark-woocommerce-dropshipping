...
include_once('WoosharkAliexpressImporter_InstallIndicator.php');

class WoosharkAliexpressImporter_LifeCycle extends WoosharkAliexpressImporter_InstallIndicator {
