...
include_once('WoosharkAmazonImporter_InstallIndicator.php');

class WoosharkAmazonImporter_LifeCycle extends WoosharkAmazonImporter_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToPluginsMenu() {
        ...
        add_menu_page(
            ...
            plugin_dir_url(__FILE__) . 'images/amazon_27x27.png');
    }
