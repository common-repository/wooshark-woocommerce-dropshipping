...
function WoosharkAliexpressImporter_noticePhpVersionWrong() {
    ...
    echo '<div class="updated fade">' .
      __('Error: plugin "wooshark aliexpress importer" requires a newer version of PHP to be running.',  'wooshark-aliexpress-importer').
